...
(function () {
   ...
   */
  var addClassOnVisibleLinkTargets = function (
    $links,
    cssClass,
...
$(function () {
  ...
  viewport
    .promise("api.slick.ready", function () {
...
$(function () {
  ...
  viewport
    .promise("api.slick.ready", function () {
      viewport
        .jQuery(".ed-element.preset-content-slider-teacher > .inner")
        .slick({
          autoplay: true,
          arrows: true,
          prevArrow:
...
$(function () {
  ...
  var buildCountdown = function (e) {
    var instances = slice.call(
        document.querySelectorAll(".countdown-instance")
      ),
    ...
    for (; i < len; i++) {
      element = instances[i];
      dataContent = window
        .getComputedStyle(instances[i], ":before")
        .content.slice(1, -1);
