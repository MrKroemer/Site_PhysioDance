  ...
  return (function () {
      ...
      r = {
            ...
            r = Class.extend({
              ...
              initTriggers: function () {
                ...
                return (
                  ...
                  viewport
                    .jQuery(document)
                    .on("click", ".wv-link-content", function (e) {
                      e.preventDefault();
                      var n = t.getMainTargetElement();
                      n &&
                        (viewport.scrollTo(n, "top", 500),
                        t.scrollAndFocusElement(n));
                    }),
                  this
                );
              },
              ...
              getMainTargetElement: function () {
                var t = document.getElementById("main-content");
                if (t) return t.parentElement || t;
                var e = document.querySelector(".menu-wrapper"),
                  n = document.querySelector(".banner"),
                  i = document.querySelector(
                    '.wv-link-content[href="#main-content"]'
                  );
                function r(t) {
                  for (
                    ;
                    t &&
                    (null === t.offsetParent || "none" === t.style.display);
                ...
                return (
                  r(null == n ? void 0 : n.nextElementSibling) ||
                  r(null == e ? void 0 : e.nextElementSibling) ||
                  r(null == i ? void 0 : i.nextElementSibling) ||
                  r(document.body.firstElementChild)
                );
              },
              scrollAndFocusElement: function (t) {
                ...
                switch (
                  ...
                  case "move-bottom-to-top":
                    var f = "move-bottom-to-top" === r.type,
                      h = 200,
                      d = this.getAnimations().getTransforms(o);
                    for (var p in d) $.Velocity.hook(o, p, d[p]);
                    i
                      ? o.velocity(
                          {
                            translateY: [
                              (d.translateY || 0) + (f ? h : -200),
                              d.translateX,
                            ],
                            opacity: [0, 1],
                          },
        ...
        88794: function (t, e, n) {
          ...
          var d = new ((function () {
              ...
              return (
                ...
                (n = [
                    ...
                    value: function () {
                      ...
                      return (
                        Object.keys(p).forEach(function (t) {
                          return (
                            (null === p[t] || void 0 === p[t]) && delete p[t]
                          );
                        }),
                        r &&
                          r.length > 0 &&
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      return this.request(
                        this.Routing.generate("cms_api_collections_delete", {
                          id: t.id,
                        }),
                        { method: "DELETE" }
                      );
            ...
            p = (n(62850), n(62773), n(96409), n(21466), n(59357), n(74860)),
            g = function () {
              var t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
              ...
              if (r && r.multiple) {
                ...
                if (d && d.url)
                  if ("img" === t.tagName.toLowerCase()) {
                    var p = new window.File(t.src),
                      g = new window.File(d.url),
                      m = y(g, v(p));
                    ...
                    var E = new window.File(
                      ...
                      j = new window.File(d.url),
                      O = y(j, v(E));
                    t.classList.contains("lazyload") ||
                    t.classList.contains("ed-lazyload")
                      ? t.setAttribute("data-background", "url(".concat(O, ")"))
                      : t.setAttribute(
                          "style",
          ...
          var I = (
            ...
            getDataBinding: function () {
              var t = this.getDataBindingElement().attr(p.Nn);
                  ...
                  this.$form.on(
                    ...
                    function (t) {
                      if (this.ajax) {
                        t.preventDefault();
                        if (
                          /^[a-f0-9]+\-([a-f0-9]+)\.preview\./.test(
                            window.location.hostname
                          ) &&
                          !confirm(
                            "You are in preview mode, and form submission is typically disabled to prevent phishing attempts. Do you want to proceed and submit the form here anyway? Click OK to continue or Cancel to stay on this page."
                          )
                        )
                          return;
                        this.submit();
          ...
          var c = (window.ElementFormDate || window.ElementBase).extend({
            ...
            updateDatepicker: function () {
              ...
              return ((t = regeneratorRuntime.mark(function t() {
                var r, a, u, l, c, f, h, d, p, g, m, v, y, w, b, x, S, E, j, O;
                      ...
                      case 3:
                        for (
                          a = t.sent,
                            ...
                            d = e.$input.attr("data-max-date"),
                            h &&
                              ((p = h.match(
                                /([0-9-]+) (days|weeks|months|years)/
                              )),
                              (c = p
                                ? l().add(p[1], p[2]).format("YYYY-MM-DD")
        ...
        13325: function (t, e, n) {
          ...
          t.exports = function t(e, n, u, l, c, f, h, d) {
            for (var p, g, m = c, v = 0, y = !!h && a(h, d, 3); v < l; ) {
              if (v in u) {
                if (
                  ((p = y ? y(u[v], v, n) : u[v]),
                  (g = !1),
                  r(p) && (g = void 0 !== (g = p[s]) ? !!g : i(p)),
                  g && f > 0)
                )
                  m = t(e, n, p, o(p.length), m, f - 1) - 1;
                else {
        ...
        42923: function (t, e, n) {
          ...
          t.exports = function (t, e, n, m, v, y, w) {
            ...
            if (
              ...
              if (
                ((b = { values: O ? T : E(p), keys: y ? T : E(d), entries: P }),
                w)
              )
        ...
        78440: function (t, e, n) {
          ...
          if (n(67057)) {
            var i = n(4461),
              ...
              Nt = function () {
                return mt.apply(Lt ? pt.call(Tt(this)) : Tt(this), arguments);
              },
              Vt = {
              ...
              _t = function (t, e) {
                return $t(this, pt.call(Tt(this), t, e));
              },
              Rt = function (t) {
                Tt(this);
                  ...
                  ? ((p = n(function (t, n, i, r) {
                      ...
                      if (x(n)) {
                        if (!(n instanceof G || (u = b(n)) == Q || u == X))
                          return St in n ? It(p, n) : Dt.call(p, n);
                        (o = n), (d = Ct(i, e));
                        var v = n.byteLength;
                        if (void 0 === r) {
                          if (v % e) throw H(jt);
                          if ((a = v - d) < 0) throw H(jt);
                        } else if ((a = g(r) * e) + d > v) throw H(jt);
                        s = a / e;
                      } else (s = m(n)), (o = new G((a = s * e)));
                      for (
                        h(t, "_d", { b: o, o: d, l: a, e: s, v: new Z(o) });
                        f < s;
            ...
            "Array",
            {
              from: function (t) {
                ...
                if (
                  ...
                  for (n = new d((e = u(h.length))); e > v; v++)
                    l(n, v, m ? g(h[v], v) : h[v]);
                else
                  for (f = y.call(h), n = new d(); !(r = f.next()).done; v++)
        ...
        11246: function (t, e, n) {
          ...
          if (!p(" 0o1") || !p("0b1") || p("+0x1")) {
            ...
            for (
              ...
              r(g, (b = x[S])) && !r(p, b) && f(p, b, c(g, b));
            (p.prototype = m), (m.constructor = p), n(77234)(i, d, p);
          }
        },
                ...
                if ((u < 0 && ((m = "-"), (u = -u)), u > 1e-21))
                  if (
                    ...
                    for (h(g(10, i, 1), 0), i = e - 1; i >= 23; )
                      d(1 << 23), (i -= 23);
                    d(1 << i), h(1, 1), d(2), (v = p());
                  } else h(0, n), h(1 << -e, 0), (v = p() + a.call(f, l));
                return (v =
                  l > 0
                    ? m +
                      ((s = v.length) <= l
          ...
          n(28082)("match", 1, function (t, e, n, s) {
            return [
              ...
              function (t) {
                ...
                var c = u.unicode;
                u.lastIndex = 0;
                for (var f, h = [], d = 0; null !== (f = a(u, l)); ) {
                  var p = String(f[0]);
                  (h[d] = p),
                    "" === p && (u.lastIndex = o(l, r(u.lastIndex), c)),
                    d++;
                }
                return 0 === d ? null : h;
              },
              ...
              [
                ...
                function (t, e) {
                  ...
                  for (var x = 0, S = 0, E = []; S < h.length; ) {
                    ...
                    if (
                      null === O ||
                      (j = f(s(w.lastIndex + (p ? 0 : S)), h.length)) === x
                    )
                      S = a(h, S, v);
                    else {
        ...
        95767: function (t, e, n) {
          ...
          for (
            ...
            d(et[nt++]);
          for (var it = T(d.store), rt = 0; it.length > rt; ) g(it[rt++]);
          a(a.S + a.F * !H, "Symbol", {
            for: function (t) {
        ...
        30147: function (t, e, n) {
          ...
          var i,
            ...
            b = (t.exports = n(45795)(p, y, w, l, !0, !0));
          h &&
            d &&
            (u((i = l.getConstructor(y, p)).prototype, w),
            (s.NEED = !0),
        ...
        19755: function (t, e) {
          ...
          !(function (e, n) {
                        ...
                        ? function (t, e) {
                            ...
                            return (
                              ...
                              (!n.sortDetached &&
                                ...
                                ? t == d || (t.ownerDocument == x && w(x, t))
                                  ? -1
                                  : e == d || (e.ownerDocument == x && w(x, e))
                                  ? 1
                                  : c
                                  ? F(c, t) - F(c, e)
                                  : 0
                ...
                return (
                  ...
                  lt(function (o, a, s, u) {
                    var l,
                      ...
                      v = n ? (r || (o ? t : p || i) ? [] : a) : m;
                    if ((n && n(m, v, s, u), i))
                      for (l = St(v, d), i(l, [], s, u), c = l.length; c--; )
                        (f = l[c]) && (v[d[c]] = !(m[d[c]] = f));
                    if (o) {
                      if (r || t) {
                        if (r) {
                    ...
                    } else (v = St(v === a ? v.splice(p, v.length) : v)), r ? r(null, a, v, u) : M.apply(a, v);
                  })
                );
              }
              function jt(t) {
                    ...
                    (d = g = (s = jt.exec(e[l]) || [])[1]),
                      ...
                      d &&
                        ...
                        (h = u[d]) ||
                          ...
                          (f.setup && !1 !== f.setup.call(t, i, p, a)) ||
                  ...
                  for (l = (e = (e || "").match(V) || [""]).length; l--; )
                    if (
                      ...
                      for (
                        f = j.event.special[d] || {},
                          h =
                            u[(d = (i ? f.delegateType : f.bindType) || d)] ||
                            [],
                          s =
                            s[2] &&
                            new RegExp(
                      ...
                      a &&
                        !h.length &&
                        ((f.teardown &&
                          !1 !== f.teardown.call(t, p, m.handle)) ||
                          j.removeEvent(t, d, m.handle),
                        delete u[d]);
                    } else for (d in u) j.event.remove(t, d + e[l], n, i, !0);
            ...
            function Vt(t, e, n, i) {
              ...
              if (
                g ||
                (h > 1 && "string" == typeof p && !m.checkClone && $t.test(p))
              )
                return t.each(function (r) {
                  var o = t.eq(r);
                  g && (e[0] = p.call(this, r, o.html())), Vt(o, e, n, i);
                });
              if (
                h &&
                ...
                function (t, e, n) {
                  ...
                  e))
                    if (((r = e[i]), ae.test(r))) {
                      ...
                      d[i] = (m && m[i]) || j.style(t, i);
                    }
                  if ((u = !j.isEmptyObject(e)) || !j.isEmptyObject(d))
                    for (i in (f &&
                      1 === t.nodeType &&
                    ...
                    d))
                      u ||
                        ...
                        g && dt([t], !0),
                        h.done(function () {
                          for (i in (g || dt([t]), K.remove(t, "fxshow"), d))
                            j.style(t, i, d[i]);
                        })),
                        (u = fe(g ? m[i] : 0, i, h)),
                        i in m ||
                    ...
                    return void 0 === t.getAttribute
                      ...
                      : ((1 === o && j.isXMLDoc(t)) ||
                          (r =
                            ...
                            (j.expr.match.bool.test(e) ? de : void 0)),
                        void 0 !== n
                          ? null === n
              ...
              j.extend({
                ...
                ajax: function (t, e) {
                  ...
                  var n,
                    ...
                    d = j.ajaxSetup({}, e),
                    p = d.context || d,
                    g = d.context && (p.nodeType || p.jquery) ? j(p) : j.event,
                    m = j.Deferred(),
                  ...
                  function O(t, e, a, u) {
                    ...
                    l ||
                      ...
                      (E.statusText = (e || S) + ""),
                      f
                        ? m.resolveWith(p, [h, S, E])
                        : m.rejectWith(p, [E, S, w]),
                      E.statusCode(y),
                      (y = void 0),
                      c &&
                ...
                (o._invoke = (function (t, e, n) {
                  ...
                  return function (r, o) {
                    ...
                    for (n.method = r, n.arg = o; ; ) {
                      ...
                      var u = c(t, e, n);
                      if ("normal" === u.type) {
                        if (((i = n.done ? p : h), u.arg === g)) continue;
            ...
            (o = function () {
              return (function (t, e, n, i) {
                ...
                if (!(o <= 7)) {
                  ...
                  e.pageYOffset !== i
                    ? ((d.State.scrollAnchor = e),
                      (d.State.scrollPropertyLeft = "pageXOffset"),
                      (d.State.scrollPropertyTop = "pageYOffset"))
                    : ((d.State.scrollAnchor =
                  ...
                  (d.Easings = {
                    ...
                    u.each(
                      ...
                      function (t, e) {
                        d.Easings[e[0]] = b.apply(null, e[1]);
                      }
                    );
                  var g = (d.CSS = {
                    RegEx: {
                    ...
                    Names: {
                      ...
                      SVGAttribute: function (t) {
                        ...
                        return (
                          (o || (d.State.isAndroid && !d.State.isChrome)) &&
                            (e += "|transform"),
                      ...
                      prefixCheck: function (t) {
                        ...
                        for (
                          ...
                          if (
                            ...
                            l.isString(d.State.prefixElement.style[r]))
                          )
                            return (d.State.prefixMatches[t] = r), [r, !0];
                        }
                        return [t, !1];
                      },
                    },
                    ...
                    getPropertyValue: function (t, n, r, a) {
                      ...
                      if (g.Hooks.registered[n]) {
                        ...
                        "transform" !==
                          ...
                          ((p = s(t, g.Names.prefixCheck(h)[0])),
                          g.Values.isCSSNullValue(p) &&
                            g.Hooks.templates[n] &&
                            (p = g.Hooks.templates[n][1])),
                          (l = g.Normalizations.registered[n]("extract", t, p));
                      }
                      if (!/^[\d-]/.test(l))
                    ...
                    (d.hook = function (t, e, n) {
                      ...
                      return (
                        ...
                        u.each(t, function (t, o) {
                          if ((y(o) === i && d.init(o), n === i))
                            r === i && (r = d.CSS.getPropertyValue(o, e));
                          else {
                            var a = d.CSS.setPropertyValue(o, e, n);
                            "transform" === a[0] &&
                              d.CSS.flushTransformCache(o),
                              (r = a);
                          }
                        }),
                        r
                    ...
                    if (
                      ...
                      v
                        ? ((h = arguments[0].properties || arguments[0].p),
                          (p = arguments[0].options || arguments[0].o))
                        : ((h = arguments[a]), (p = arguments[a + 1]));
                      var w = c.length,
                        b = 0;
                      if (
                        ...
                        for (var O = j; O < arguments.length; O++)
                          ...
                          (!/^(fast|normal|slow)$/i.test(arguments[O]) &&
                            ...
                            ? l.isString(arguments[O]) ||
                              l.isArray(arguments[O])
                              ? (p.easing = arguments[O])
                              : l.isFunction(arguments[O]) &&
                                (p.complete = arguments[O])
                            : (p.duration = arguments[O]);
                      }
                      var k,
                      ...
                      switch (
                        (r &&
                          d.Promise &&
                          (A.promise = new d.Promise(function (t, e) {
                        ...
                        case "stop":
                          ...
                          var C = [];
                          return (
                            u.each(d.State.calls, function (t, e) {
                              e &&
                        ...
                        default:
                          if (!u.isPlainObject(h) || l.isEmptyObject(h)) {
                            if (l.isString(h) && d.Redirects[h]) {
                              var T = (I = u.extend({}, p)).duration,
                                P = I.delay || 0;
                              return (
                                !0 === I.backwards &&
                      ...
                      if (
                        ...
                        ((I = u.extend({}, d.defaults, p)).loop = parseInt(
                          I.loop
                        )),
                        (M = 2 * I.loop - 1),
                        I.loop)
                      ...
                      function s(s) {
                        ...
                        if ("scroll" === k) {
                          ...
                          "none" === y(r).opts.display &&
                            ...
                            p.easing || delete o.easing,
                            p.duration || delete o.duration,
                          ...
                          for (var C in O)
                            if ("element" !== C) {
                              ...
                              (O[C].startValue = O[C].currentValue =
                                O[C].endValue),
                                (O[C].endValue = T),
                                l.isEmptyObject(p) || (O[C].easing = o.easing),
                                d.debug &&
                                  console.log(
                              ...
                              if (o && i)
                                ...
                                d.init(l),
                                  ...
                                  u.each(
                                    ...
                                    function (t, e) {
                                      d.CSS.setPropertyValue(l, e, "hidden");
                                    }
                                  ),
                                  d.CSS.setPropertyValue(
                                    l,
                                    "position",
                                    t.position
                                  ),
                                  ...
                                  u.each(
                                    ...
                                    function (t, e) {
                                      d.CSS.setPropertyValue(l, e, "100%");
                                    }
                                  ),
                                  d.CSS.setPropertyValue(
                                    l,
                        ...
                        a.element &&
                          ...
                          (y(r).isAnimating = !0),
                          b === w - 1
                            ? (d.State.calls.push([F, c, o, null, A.resolver]),
                              !1 === d.State.isTicking &&
                                ((d.State.isTicking = !0), S()))
                            : b++);
                      }
                      !1 !== d.mock &&
                        (!0 === d.mock
                          ? (o.duration = o.delay = 1)
                          : ((o.duration *= parseFloat(d.mock) || 1),
                            (o.delay *= parseFloat(d.mock) || 1))),
                        ...
                        o.display !== i &&
                          ...
                          "auto" === o.display &&
                            (o.display = d.CSS.Values.getDisplayType(r))),
                        o.visibility !== i &&
                          null !== o.visibility &&
                  ...
                  return (
                    ...
                    u.each(["Down", "Up"], function (t, e) {
                      d.Redirects["slide" + e] = function (t, n, r, o, a, s) {
                        var l = u.extend({}, n),
                          c = l.begin,
                          f = l.complete,
                          h = {
                        ...
                        l.display === i &&
                          (l.display =
                            "Down" === e
                              ? "inline" === d.CSS.Values.getDisplayType(t)
                                ? "inline-block"
                                : "block"
                              : "none"),
                          (l.begin = function () {
                            for (var n in (c && c.call(a, a), h)) {
                              p[n] = t.style[n];
                              var i = d.CSS.getPropertyValue(t, n);
                              h[n] = "Down" === e ? [i, 0] : [0, i];
                            }
                    ...
                    u.each(["In", "Out"], function (t, e) {
                      d.Redirects["fade" + e] = function (t, n, r, o, a, s) {
                        var l = u.extend({}, n),
                          c = { opacity: "In" === e ? 1 : 0 },
                          f = l.complete;
                        (l.complete =
                ...
                function b(t, n, i, r) {
                  ...
                  function v(t, e, n) {
                    return ((p(e, n) * t + g(e, n)) * t + m(e)) * t;
                  }
                  function y(t, e, n) {
                    return 3 * p(e, n) * t * t + 2 * g(e, n) * t + m(e);
                  }
                  function w(e, n) {
                    for (var r = 0; r < o; ++r) {
                      var a = y(n, t, i);
                  ...
                  function b() {
                    for (var e = 0; e < l; ++e) d[e] = v(e * c, t, i);
                  }
                  function x(e, n, r) {
                    var o,
                      a,
                  ...
                  function S(e) {
                    for (var n = 0, r = 1, o = l - 1; r != o && d[r] <= e; ++r)
                      n += c;
                    --r;
                    var s = n + ((e - d[r]) / (d[r + 1] - d[r])) * c,
                      u = y(s, t, i);
                    ...
                    l.isString(t)
                      ...
                      : (n =
                          l.isArray(t) && 1 === t.length
                            ...
                            ? p.apply(null, t.concat([e]))
                            : !(!l.isArray(t) || 4 !== t.length) &&
                              b.apply(null, t)),
                    !1 === n &&
                      (n = d.Easings[d.defaults.easing]
                        ? d.defaults.easing
                        : h),
                    n
                  );
                ...
                function S(t) {
                    ...
                    for (var r = 0; r < n; r++)
                      if (d.State.calls[r]) {
                        var o = d.State.calls[r],
                          ...
                          f = !!c,
                          h = null;
                        c || (c = d.State.calls[r][3] = e - 16);
                        for (
                          var p = Math.min((e - c) / s.duration, 1),
                            m = 0,
                            w = a.length;
                          m < w;
                          m++
                        ...
                        s.display !== i &&
                          "none" !== s.display &&
                          (d.State.calls[r][2].display = !1),
                          s.visibility !== i &&
                            "hidden" !== s.visibility &&
                            (d.State.calls[r][2].visibility = !1),
                          s.progress &&
                            s.progress.call(
                              o[1],
                              o[1],
                  ...
                  d.State.isTicking && v(S);
                }
                function E(t, e) {
                  if (!d.State.calls[t]) return !1;
                  for (
                    var n = d.State.calls[t][0],
                      r = d.State.calls[t][1],
                      o = d.State.calls[t][2],
                      a = d.State.calls[t][4],
                      s = !1,
                    ...
                    a && !0 !== o.loop && a(r),
                      y(f) &&
                        ...
                        d(f, "reverse", { loop: !0, delay: o.delay })),
                      !1 !== o.queue && u.dequeue(f, o.queue);
                  }
                  d.State.calls[t] = !1;
                  for (var p = 0, m = d.State.calls.length; p < m; p++)
                    if (!1 !== d.State.calls[p]) {
                      s = !0;
                      break;
                    }
                  !1 === s &&
                ...
                function (t, e) {
                  ...
                  return (
                    (r.Redirects[t] = function (a, s, u, l, c, f) {
                      ...
                      for (var d = 0; d < e.calls.length; d++) {
                        var p = e.calls[d],
                          g = p[0],
    ...
    return (
      (function () {
        ...
        var d = a(35731);
        window.ElementGallery = d.default || d;
        var p = a(69212);
        window.ElementGrid = p.default || p;
        var g = a(56923);
